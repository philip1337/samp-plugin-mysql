vars = {
	...
	'github_timniederhausen' : 'https://github.com/timniederhausen',
	'github_philip' : 'https://github.com/philip1337',
	'github_fmtlib' : 'https://github.com/fmtlib',
	'github_mariadb' : 'https://github.com/MariaDB',
	'github_moerder' : 'https://github.com/maddinat0r',
}
